...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, fullName: $fullName, email: $email, avatar: $avatar, school: $school, level: $level, graduationYear: $graduationYear)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, fullName, email, avatar, school, level, graduationYear);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String graduationYear}) = _$UserImpl;
